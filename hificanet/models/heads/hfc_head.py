...
from hificanet.utils.lane import Lane
from hificanet.models.losses.focal_loss import FocalLoss
from hificanet.models.losses.accuracy import accuracy
from hificanet.ops import nms

from hificanet.models.utils.roi_gather import ROIGather, LinearModule
from hificanet.models.utils.seg_decoder import SegDecoder
from hificanet.models.utils.dynamic_assign import assign
from hificanet.models.losses.Dlineiou_loss import Dliou_loss
from ..registry import HEADS


@HEADS.register_module
class HFCHead(nn.Module):
    def __init__(self,
                 num_points=72,
    ...
    def forward(self, x, **kwargs):
        ...
        for stage in range(self.refine_layers):
            ...
            #print(batch_features[stage].shape)
    ...
    def loss(self,
        ...
        cls_criterion = FocalLoss(alpha=0.25)
        cls_loss = 0
        reg_xytl_loss = 0
        iou_loss = 0
        cls_acc = []
        ...
        for stage in range(self.refine_layers):
            ...
            cls_acc.append(sum(cls_acc_stage) / (len(cls_acc_stage)+1e-9))
